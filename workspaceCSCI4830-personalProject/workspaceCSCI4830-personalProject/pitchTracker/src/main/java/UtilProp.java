...
public class UtilProp {
   ...
   static String _PROP_FILENAME_WIN_LOCAL = "C:\\Users\\jaxon\\eclipse-workspaces\\workspaceCSCI4830-personalProject\\pitchTracker\\src\\main\\webapp\\config.properties";
   static String _PROP_FILENAME_OSX_LOCAL = "/YOUR_PATH/webproject-ex-0206-Jensen/WebContent/config.properties";
   
   // * Remote server path
   static String _PROP_FILENAME_REMOTE = "/var/lib/tomcat9/webapps/pitchTracker/config.properties";
