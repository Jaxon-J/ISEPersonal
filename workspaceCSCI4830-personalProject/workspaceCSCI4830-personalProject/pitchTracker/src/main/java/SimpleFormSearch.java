...
public class SimpleFormSearch extends HttpServlet {
   ...
   void search(String keyword, HttpServletResponse response) throws IOException {
      ...
      out.println("</head>");
      out.println("<body>");
      out.println("<header style=\"background-color:black; color:white; text-align:center; padding:30px; position: fixed; top: 0; left: 0; width: 100%; font-size: 30px; font face = Times New Roman;\"><b>Search Result</b></header>"); // Modified header content
